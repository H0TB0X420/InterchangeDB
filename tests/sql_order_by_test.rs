...
fn setup() -> Setup {
    ...
    table
        .insert(&[
            Value::Int32(2),
            Value::Varchar("kim".into()),
            Value::Varchar("b".into()),
        ])
        .unwrap();
    table
        .insert(&[Value::Int32(4), Value::Varchar("kim".into()), Value::Null])
        .unwrap();
